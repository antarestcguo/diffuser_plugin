...
from plugin_modules.ip_adapter import IPAdapterXL, IPAdapter,IPAdapterPlusXL
...
save_path = "./tmp_ip_adpater_result4shape_base"
...
for i, sub_style_folder in enumerate(list(style_config_dict.keys())):
    ...
    if i >= args.start_idx and i <= args.end_idx:
        ...
        for pinyin in word_list[0]:
                ...
                # set large strength
                strength = 0.95
                images = ip_model_refine.generate(pil_image=image, num_samples=4, num_inference_steps=args.num_inference_steps,
                ...
                if "enhance" in style_config_dict[sub_style_folder]:
                    ...
                    for i, it in enumerate(images):
                        ...
                        enhance_img, pre_enhance = paste_maxtext(pinyin, it, fg_color, bg_color,
                                                                 ...
                                                                 b_bg=b_complexity)
                        # set enhance image to original gen_it
                        # set refine_strength = 0.7
                        refine_strength = 0.7
                        enhance_img = it
