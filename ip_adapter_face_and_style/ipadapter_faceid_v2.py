...
from plugin_modules.ip_adapter.ip_adapter_faceid import IPAdapterFaceIDXL, IPAdapterFaceIDPlusXL
import torch
import cv2

save_path = "./tmp_diffuser_plugin/ipadapter_faceidplusv2_result/"
...
ip_ckpt = "/data/tc_guo/models/IP-Adapter-FaceID/ip-adapter-faceid-plusv2_sdxl.bin"
...
prompt = "photo of a lady,(masterpiece:1.2),(best quality:1.2),"
...
images = ip_model.generate(prompt=prompt, negative_prompt=negative_prompt, faceid_embeds=average_embedding,
                           scale=likeness_strength, face_image=face_image, shortcut=True, num_samples=4,
                           s_scale=face_strength, width=1024, height=1024, num_inference_steps=30, guidance_scale=7.5,seed=None,
                           )
