...
if is_torch2_available():
    from plugin_modules.instantID.ip_adapter.attention_processor import IPAttnProcessor2_0 as IPAttnProcessor, AttnProcessor2_0 as AttnProcessor
else:
    from plugin_modules.instantID.ip_adapter.attention_processor import IPAttnProcessor, AttnProcessor
from plugin_modules.instantID.ip_adapter.attention_processor import region_control
